...
public class JdbctemplateApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		System.out.println("O número de registro da tabela contatos é: " + rowCount);
		String telefone = this.jdbcTemplate.queryForObject("select telefone from contatos where nome = ?",
				String.class, "Edson Angoti Júnior");
		System.out.println("O telefone de Edson Angoti Júnior: " + telefone);
	}
}
